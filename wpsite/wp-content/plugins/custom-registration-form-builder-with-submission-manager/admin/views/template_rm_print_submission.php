        ...
        <div class="rmagic">
            ...
            <table class="rm-submission">
                ...
                if ($data->form_type_status == "1" && !empty($data->user))
                {
                    ...
                    ?>
                    <tr class="rm-submission-field-row">
                        <td class="rm-submission-label"><?php echo wp_kses_post(RM_UI_Strings::get('LABEL_USER_NAME')); ?> :</td>
                ...
                if ($data->payment)
                {
                    ...
                    <tr class="rm-submission-field-row">
                        ...
                        <td class="rm-submission-value"><?php if (isset($data->payment->status)) echo esc_html($data->payment->status); ?></td>
                    </tr>
                    <tr class="rm-submission-field-row">
