...
<div class="rm_pr_page">
    ...
    <!----Main Pitch---->
         ...
         <div class="rm-box-wrap rm-premium-box-wrap">       
            <div class="rm-box-row rm-box-white-bg">
                <div class="rm-box-col-3 rm-premium-icon-col">
                    <div class="rm-premium-icon"><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/svg/rm-premium-icon.svg'); ?>" class="aligncenter" alt="img" title="RegistrationMagic"></div>
                </div>
                <div class="rm-box-col-9 rm-premium-text-col rm-d-flex rm-box-center rm-box-text-center rm-flex-direction-col rm-d-flex-v-center">
                    <div class="rm-premium-banner-logo rm-card-mb-16"><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/svg/rm-logo.svg'); ?>" class="aligncenter" alt="img" title="RegistrationMagic"></div>
                    <div class="rm-premium-banner-head rm-card-mb-16"><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/svg/head-text.svg'); ?>" class="aligncenter" alt="img" title="RegistrationMagic"></div>
                    <div class="rm-premium-banner-subhead rm-card-mb-16"> <?php _e('Get all RegistrationMagic extensions as part of <strong>single heavily discounted price!</strong> This also includes all future extensions.', 'custom-registration-form-builder-with-submission-manager'); ?> </div>
                    <div class="rm_pitch_action_button">
                        <a href="<?php echo esc_url(RM_Utilities::comparison_page_link()); ?>" target="_blank"><button class="rm_pr_action"><?php esc_html_e('Buy Now', 'custom-registration-form-builder-with-submission-manager'); ?> </button></a>
                    </div>
                </div>            
            </div>        
        </div>
        ...
        <div class="rm-box-wrap rm-premium-box-wrap">       
            <div class="rm-box-row rm-box-white-bg">
                <div class="rm-box-col-3 rm-premium-icon-col">
                    <div class="rm-premium-icon"><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/svg/rm-premium-icon.svg'); ?>" class="aligncenter rm-box-h-100" alt="img" title="RegistrationMagic"></div>
                </div>
                <div class="rm-premium-banner-head rm-box-col-9 rm-d-flex rm-box-center rm-box-text-center rm-flex-direction-col rm-d-flex-v-center">
                    <div class="rm-premium-banner-head rm-card-mb-16"><img src="<?php echo esc_url(plugin_dir_url(dirname(dirname(__FILE__))) . 'images/svg/head-text.svg'); ?>" class="aligncenter" alt="img" title="RegistrationMagic"></div>
                    <div class="rm-premium-banner-subhead rm-card-mb-16"> <?php _e('Get all RegistrationMagic extensions as part of <strong>single heavily discounted price!</strong> This also includes all future extensions.', 'custom-registration-form-builder-with-submission-manager'); ?> </div>
                    <div class="rm_pitch_action_button">
                        <a href="<?php echo esc_url(RM_Utilities::comparison_page_link()); ?>" target="_blank"><button class="rm_pr_action"><?php esc_html_e('Buy Now', 'custom-registration-form-builder-with-submission-manager'); ?> </button></a>
