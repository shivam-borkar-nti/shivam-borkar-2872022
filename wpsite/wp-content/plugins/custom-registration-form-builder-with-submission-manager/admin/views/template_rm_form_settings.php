          ...
          <?php if($data->form_options->form_expired_by)
            ...
            <div <?php echo wp_kses_post($tooltip);?> class="rm-grid-sidebar-row dbfl <?php echo esc_attr($deactivation_class); ?>">
                ...
                <div class="rm-grid-sidebar-row-value difl<?php echo ($data->form_options->form_expired_by) ? '' : ' rm_deactivated' ?>"><div class="rm-grid-sidebar-row-value difl"><div class="switch">
                            <input id="rm-toggle-5" class="rm-toggle rm-toggle-round-flat" onchange="rm_fd_quick_toggle(this, <?php echo esc_attr($data->form_id); ?>)" name="form_should_auto_expire" type="checkbox"<?php echo $data->form->get_form_should_auto_expire() == 1 ? ' checked' : '' ?>>
