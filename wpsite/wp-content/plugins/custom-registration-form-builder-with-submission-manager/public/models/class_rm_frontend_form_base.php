...
abstract class RM_Frontend_Form_Base
{
    ...
    public function pre_render()
    {
        ...
        if($this->form_options->btn_hover_color)
            echo '.rmagic #form_' . wp_kses_post($this->form_id) . "_" . wp_kses_post($this->form_number) .' .buttonarea input[type="button"]:hover{ background-color:'.wp_kses_post($this->form_options->btn_hover_color).wp_kses_post($important).';}';
        if($this->form_options->field_bg_focus_color || $this->form_options->text_focus_color){
            echo '.rmagic #form_' . wp_kses_post($this->form_id) . "_" . wp_kses_post($this->form_number) .' .rmrow input:focus,.rmagic #form_'.wp_kses_post($this->form_id).'_'.wp_kses_post($this->form_number).' .rmrow select:focus,.rmagic #form_'.wp_kses_post($this->form_id).'_'.wp_kses_post($this->form_number).' .rmrow textarea:focus{';
