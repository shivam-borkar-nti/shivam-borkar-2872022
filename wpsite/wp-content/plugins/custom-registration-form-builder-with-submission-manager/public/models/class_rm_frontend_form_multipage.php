...
class RM_Frontend_Form_Multipage extends RM_Frontend_Form_Base
{
    ...
    public function prepare_fields_for_render($form,$editing_sub=null)
    {
        ...
        if(isset($_GET['form_prev']) && current_user_can('manage_options')) {
            $form->addElement(new Element_HTML("<div class=\"rm-form-preview-notice\">".__("Admin Notice: Account creation fields are disabled in this preview.", 'custom-registration-form-builder-with-submission-manager')."</div>"));
        }
