...
<div class="rmagic" id="rm_front_sub_tabs" style="display: none;"> 
    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            ...
            echo $setting->generate_profile_tab_links();
    ...
    echo $setting->rm_profile_tabs_content($data, $data->user->ID);
    
    if(isset($data->user,$data->user->ID))
        echo wp_kses(apply_filters('rm_after_front_tabcontent_listing', '',$data->user->ID),RM_Utilities::expanded_allowed_tags());
    ?>
</div>
<?php //} ?>