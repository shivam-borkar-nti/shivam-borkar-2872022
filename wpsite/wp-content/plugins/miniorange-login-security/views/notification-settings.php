...
$email= get_site_option("admin_email_address_status")?get_site_option("admin_email_address"):'';
...
echo'		<h3>Email Notifications</h3>
             ...
             <form id="mo_wpns_get_manual_email" method="post" action="">
              ...
              Enter your E-mail :<input type= "email" name="admin_email_address" placeholder="miniorange@gmail.com" value="'.esc_attr($email).'">
			...
			<form id="mo_wpns_enable_ip_blocked_email_to_admin" method="post" action="">
				...
				<input type="checkbox" name="enable_ip_blocked_email_to_admin" '.esc_attr($notify_admin_on_ip_block).' onchange="document.getElementById(\'mo_wpns_enable_ip_blocked_email_to_admin\').submit();"'; if(!get_site_option("admin_email_address_status")|| get_site_option("admin_email_address") ==''){echo "disabled";} 
...
echo'		</form>
			...
			<form id="mo_wpns_enable_unusual_activity_email_to_user" method="post" action="">
				...
				<input type="checkbox" name="enable_unusual_activity_email_to_user" '.esc_attr($notify_admin_unusual_activity).' onchange="document.getElementById(\'mo_wpns_enable_unusual_activity_email_to_user\').submit();"';if(!get_site_option("admin_email_address_status") || get_site_option("admin_email_address") ==''){echo "disabled";} 
