<?php?>
                ...
                <div>
					...
					<div style="text-align:center;">
						...
						<input type="email" id="query_mail" name="query_mail" style="text-align:center; border:0px solid black; border-style:solid; background:#f0f3f7; width:20vw;border-radius: 6px;"
                              placeholder="your email address" required value="<?php echo esc_url($email); ?>" readonly="readonly"/>
    ...
    <script>
        jQuery('a[aria-label="Deactivate Multi Factor Authentication"]').click(function () {
