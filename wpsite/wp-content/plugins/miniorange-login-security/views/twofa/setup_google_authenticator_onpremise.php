            ...
            <td class="mo2f_google_authy_step2">
                ...
                <div style="margin-left:40px;">
                    <form name="f"  id="login_settings_appname_form" method="post" action="">
                        ...
                        <input type="submit" name="submit" value="Save App Name" class="mo_wpns_button mo_wpns_button1" /><br>
                    </form>
                </div>
                </div>
                ...
                <div style="margin-left:40px;">
                    ...
                    <div class="mo2f_gauth_column mo2f_gauth_left" >
                        <div class="mo2f_gauth" data-qrcode="<?php echo esc_attr($url);?>" style="float:left;margin-left:10%;"></div>
                    </div>
