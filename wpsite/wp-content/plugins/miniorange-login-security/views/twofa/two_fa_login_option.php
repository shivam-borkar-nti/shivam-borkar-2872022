...
<?php if ( !get_site_option( 'mo2f_is_NC' ) && get_site_option( 'mo2f_is_NC' ) ) { ?>
                ...
                <form name="f" id="login_settings_form" method="post" action="">
                    ...
                    <div style="margin-left: 2%;">
                        ...
                        <div style="margin-left:6%;">
							...
							if ( $mo_2factor_user_registration_status == 'MO_2_FACTOR_PLUGIN_SETTINGS' and get_site_option('is_onprem')!=1)  {
							} else {
								echo 'disabled';
							} ?> />Enable
                        ...
                        <i>(<?php echo mo2f_lt( 'No password required.' ); ?>)</i> &nbsp;<a 
                            data-toggle="collapse"id="showpreview1"href="#preview9"aria-expanded="false"><?php echo mo2f_lt( 'See preview' ); ?></a>
                        <br>
                    ...
                    <div style="margin-left: 2%">
                        <input type="checkbox" id="mo2f_forgotphone" name="mo2f_forgotphone"
                               value="1" <?php checked( get_site_option( 'mo2f_enable_forgotphone' ) == 1 );
    ...
    >					<?php echo mo2f_lt( 'Enable Forgot Phone.' ); ?>
                        ...
                        <br>
                                        ...
                                        <div>
                        <h3 style="padding:10px;"><?php echo mo2f_lt( 'Enable Two-Factor plugin' ); ?></h3></div>
                    <hr>
                    <br>
                    <div style="margin-left: 2%">
    ...
    >                   <?php echo mo2f_lt( ' Enable Two-Factor plugin. ( If you disable this checkbox, Two-Factor plugin will not invoke for any user during login.)' ); ?>

                        <div class="mo2f_advanced_options_note"><p style="padding:5px;">
                                <i><?php echo mo2f_lt( 'Disabling this option will allow all users to login with their username and password.Two-Factor will not invoke during login.' ); ?></i>
                            </p></div>
                        <br>
                    ...
                    <div style="margin-left: 2%">
                        <input type="checkbox" id="mo2f_enable_xmlrpc" name="mo2f_enable_xmlrpc"
                               value="1" <?php checked( get_site_option( 'mo2f_enable_xmlrpc' ) == 1 );
						if ( $mo_2factor_user_registration_status == 'MO_2_FACTOR_PLUGIN_SETTINGS' ) {
						} else {
							echo 'disabled';
						} ?> />
                    ...
                    <div style="padding:10px;">
						...
						if ( $mo_2factor_user_registration_status == 'MO_2_FACTOR_PLUGIN_SETTINGS' or get_site_option('is_onprem')) {
                            ...
                            ?>
                            <input type="submit" name="submit" value="<?php echo mo2f_lt( 'Save Settings' ); ?>"
                               class="mo_wpns_button" disabled style="background-color: var(--mo2f-theme-color);padding: 11px 28px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px;">
                            <?php
						} ?> 
                        </center>
                    </div>
