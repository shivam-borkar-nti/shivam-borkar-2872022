...
function mo2f_configure_authy_authenticator( $user ) {
	$mo2f_authy_auth = isset( $_SESSION['mo2f_authy_keys'] ) ? esc_attr ($_SESSION['mo2f_authy_keys']) : null;
	$data            = isset( $_SESSION['mo2f_authy_keys'] ) ? esc_attr($mo2f_authy_auth['authy_qrCode']) : null;
	$authy_secret    = isset( $_SESSION['mo2f_authy_keys'] ) ? esc_attr($mo2f_authy_auth['mo2f_authy_secret']) : null;
	?>
    <table>
        <tr>
                        ...
                        <ol class="mo2f_ol">
                            ...
                            <div class="mo2f_google_authy_secret_outer_div">
                                <div class="mo2f_google_authy_secret_inner_div">
									<?php echo esc_attr($authy_secret); ?>
                                </div>
