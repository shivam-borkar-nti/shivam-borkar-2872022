...
function wpns_handle_save()
{
                        ...
                        $enabledrole = $_POST['enabledrole'];
                         foreach($enabledrole as $role){
  						...
  						update_site_option('mo2fa_author_login_url',$_POST['mo2fa_author_login_url']);
  						update_site_option('mo2fa_subscriber_login_url',$_POST['mo2fa_subscriber_login_url']);
  						update_site_option('mo2fa_contributor_login_url',$_POST['mo2fa_contributor_login_url']);
  						update_site_option('mo2fa_editor_login_url',$_POST['mo2fa_editor_login_url']);
